...
% PUBLICATION:
%   Laxmidhar Behera, Vipul Arora and Ajay Pratap Yadav,
%   "Optimal Convergence Rate in Feed Forward Neural Networks using HJB
%   Equation", IEEE Transactions on Neural Networks and Learning Systems
%   (submitted)
...
global denZero
denZero = 1e-4;
params.K = 6000; % max epochs
params.tolErr = 0.01;
params.maxErr = 0.2;
Nhidden = 15; % No. of hidden layers in NN
Ntrial = 20; % No. of trials, each with different initialization of NN weights

%% DATA
load cancer_dataset
data.in = cancerInputs';
data.out = cancerTargets(1,:)';

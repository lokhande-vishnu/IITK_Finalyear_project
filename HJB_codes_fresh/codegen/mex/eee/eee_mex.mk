START_DIR = C:\Users\vishnu\Desktop\NN\HJB_CO~3
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\eee"
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\eee\interface"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\eee/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"

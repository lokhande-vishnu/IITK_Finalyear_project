START_DIR = C:\Users\vishnu\Desktop\NN\DEEPLE~1\NN

MATLAB_ROOT = C:\PROGRA~1\MATLAB\MATLAB~1\R2015a
MAKEFILE = sigm_mex.mk

include sigm_mex.mki
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\sigm"
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\sigm\interface"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\sigm/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
